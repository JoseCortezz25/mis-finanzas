...
**For ANY work involving user interface, components, pages, or visual elements**, you MUST ALSO read:

`.claude/knowledge/brand-guidelines.md`

This document contains mandatory brand guidelines with exact design specifications, color codes, spacing rules, typography scales, and component patterns. Violating these guidelines is unacceptable.
...
- `.claude/knowledge/brand-guidelines.md` - MANDATORY for all UI/component work (design specifications, colors, typography, spacing)
...
**Brand details in `.claude/knowledge/brand-guidelines.md`**
...
- Follow brand guidelines for ALL UI work (colors, typography, spacing, components)
...
- [ ] Read `.claude/knowledge/brand-guidelines.md` (if working on UI/components)?
